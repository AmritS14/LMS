...
//        QuickAction(title: "Digital\nDocuments", icon: "doc.richtext.fill", color: .cyan, gradient: [Color(red: 0.2, green: 0.75, blue: 0.9), Color(red: 0.1, green: 0.6, blue: 0.8)], pendingCount: 6, destination: .documents)
    ...
    static let recentApplications: [LOLoanApplication] = [
        LOLoanApplication(
            ...
            documents: [
                LOLoanDocument(name: "Aadhaar Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -3, to: Date()), ocrVerified: true, icon: "person.text.rectangle.fill"),
                LOLoanDocument(name: "PAN Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -3, to: Date()), ocrVerified: true, icon: "creditcard.fill"),
                LOLoanDocument(name: "Salary Slips (3 months)", type: "Income", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -3, to: Date()), ocrVerified: true, icon: "doc.text.fill"),
                LOLoanDocument(name: "Bank Statement", type: "Financial", status: .pending, uploadDate: nil, ocrVerified: false, icon: "building.columns.fill"),
                LOLoanDocument(name: "Property Documents", type: "Collateral", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -3, to: Date()), ocrVerified: false, icon: "house.fill"),
                LOLoanDocument(name: "Employment Letter", type: "Employment", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -3, to: Date()), ocrVerified: false, icon: "envelope.open.fill")
            ],
            timeline: [
        ...
        LOLoanApplication(
            ...
            documents: [
                LOLoanDocument(name: "Aadhaar Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -4, to: Date()), ocrVerified: true, icon: "person.text.rectangle.fill"),
                LOLoanDocument(name: "PAN Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -4, to: Date()), ocrVerified: true, icon: "creditcard.fill"),
                LOLoanDocument(name: "Business Registration", type: "Business", status: .missing, uploadDate: nil, ocrVerified: false, icon: "doc.text.fill"),
                LOLoanDocument(name: "Bank Statement", type: "Financial", status: .pending, uploadDate: nil, ocrVerified: false, icon: "building.columns.fill")
            ],
            timeline: [
        ...
        LOLoanApplication(
            ...
            documents: [
                LOLoanDocument(name: "Aadhaar Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -2, to: Date()), ocrVerified: true, icon: "person.text.rectangle.fill"),
                LOLoanDocument(name: "PAN Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -2, to: Date()), ocrVerified: true, icon: "creditcard.fill"),
                LOLoanDocument(name: "Address Proof", type: "Address", status: .tampered, uploadDate: Calendar.current.date(byAdding: .day, value: -2, to: Date()), ocrVerified: false, icon: "mappin.circle.fill"),
                LOLoanDocument(name: "Income Proof", type: "Income", status: .missing, uploadDate: nil, ocrVerified: false, icon: "doc.text.fill")
            ],
            timeline: [
        ...
        LOLoanApplication(
            ...
            documents: [
                LOLoanDocument(name: "Aadhaar Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -5, to: Date()), ocrVerified: true, icon: "person.text.rectangle.fill"),
                LOLoanDocument(name: "PAN Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -5, to: Date()), ocrVerified: true, icon: "creditcard.fill"),
                LOLoanDocument(name: "Bank Statement", type: "Financial", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -5, to: Date()), ocrVerified: true, icon: "building.columns.fill"),
                LOLoanDocument(name: "Property Documents", type: "Collateral", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -5, to: Date()), ocrVerified: true, icon: "house.fill"),
                LOLoanDocument(name: "Employment Letter", type: "Employment", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -5, to: Date()), ocrVerified: true, icon: "envelope.open.fill")
            ],
            timeline: [
        ...
        LOLoanApplication(
            ...
            documents: [
                LOLoanDocument(name: "Aadhaar Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -1, to: Date()), ocrVerified: true, icon: "person.text.rectangle.fill"),
                LOLoanDocument(name: "PAN Card", type: "Identity", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -1, to: Date()), ocrVerified: true, icon: "creditcard.fill"),
                LOLoanDocument(name: "Admission Letter", type: "Education", status: .verified, uploadDate: Calendar.current.date(byAdding: .day, value: -1, to: Date()), ocrVerified: true, icon: "doc.text.fill"),
                LOLoanDocument(name: "Co-borrower PAN", type: "Identity", status: .pending, uploadDate: nil, ocrVerified: false, icon: "creditcard.fill")
            ],
            timeline: [
    ...
    static let sampleDocuments: [LOLoanDocument] = [
        LOLoanDocument(name: "Aadhaar Card", type: "Identity", status: .verified, uploadDate: Date(), ocrVerified: true, icon: "person.text.rectangle.fill"),
        LOLoanDocument(name: "PAN Card", type: "Identity", status: .verified, uploadDate: Date(), ocrVerified: true, icon: "creditcard.fill"),
        LOLoanDocument(name: "Salary Slips (3 months)", type: "Income", status: .verified, uploadDate: Date(), ocrVerified: true, icon: "doc.text.fill"),
        LOLoanDocument(name: "Bank Statement", type: "Financial", status: .pending, uploadDate: nil, ocrVerified: false, icon: "building.columns.fill"),
        LOLoanDocument(name: "Property Documents", type: "Collateral", status: .missing, uploadDate: nil, ocrVerified: false, icon: "house.fill"),
        LOLoanDocument(name: "Employment Letter", type: "Employment", status: .verified, uploadDate: Date(), ocrVerified: false, icon: "envelope.open.fill"),
        LOLoanDocument(name: "Address Proof", type: "Address", status: .tampered, uploadDate: Date(), ocrVerified: true, icon: "mappin.circle.fill"),
        LOLoanDocument(name: "ITR (2 years)", type: "Tax", status: .duplicate, uploadDate: Date(), ocrVerified: false, icon: "doc.on.doc.fill")
    ]
...
//    ]
    ...
    static let conversations: [BorrowerConversation] = [
        BorrowerConversation(
            ...
            unreadCount: 2,
            messages: [
                LOChatMessage(text: "Hello Priya, this is regarding your home loan application. We need your latest bank statement.", sender: .officer, timestamp: Calendar.current.date(byAdding: .hour, value: -3, to: Date())!, isRead: true),
                LOChatMessage(text: "Hi! Yes, I'll arrange that. Which months do you need?", sender: .borrower, timestamp: Calendar.current.date(byAdding: .hour, value: -2, to: Date())!, isRead: true),
                LOChatMessage(text: "Please provide the last 6 months' statements from your primary salary account.", sender: .officer, timestamp: Calendar.current.date(byAdding: .hour, value: -1, to: Date())!, isRead: true),
                LOChatMessage(text: "Sure, I'll upload them by end of day.", sender: .borrower, timestamp: Calendar.current.date(byAdding: .minute, value: -45, to: Date())!, isRead: true),
                LOChatMessage(text: "Thank you! I'll upload the bank statement today.", sender: .borrower, timestamp: Calendar.current.date(byAdding: .minute, value: -30, to: Date())!, isRead: false)
            ],
            isOnline: true
        ),
        BorrowerConversation(
            ...
            unreadCount: 1,
            messages: [
                LOChatMessage(text: "Mr. Patel, your KYC is partially complete. Please submit your GST registration certificate.", sender: .officer, timestamp: Calendar.current.date(byAdding: .day, value: -1, to: Date())!, isRead: true),
                LOChatMessage(text: "I've sent the GST certificate to your email.", sender: .borrower, timestamp: Calendar.current.date(byAdding: .hour, value: -5, to: Date())!, isRead: true),
                LOChatMessage(text: "When can I expect the approval?", sender: .borrower, timestamp: Calendar.current.date(byAdding: .hour, value: -2, to: Date())!, isRead: false)
            ],
            isOnline: false
        ),
        BorrowerConversation(
            ...
            unreadCount: 0,
            messages: [
                LOChatMessage(text: "Congratulations! Your home loan has been approved. The sanction letter will be generated shortly.", sender: .officer, timestamp: Calendar.current.date(byAdding: .hour, value: -1, to: Date())!, isRead: true),
                LOChatMessage(text: "That's wonderful news! Thank you so much for your help.", sender: .borrower, timestamp: Calendar.current.date(byAdding: .minute, value: -50, to: Date())!, isRead: true)
            ],
            isOnline: true
        )
    ]
